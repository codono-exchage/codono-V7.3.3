...
class BuilderConfig extends AdminBuilder
{
    ...
    {
        return NumToStr($this->key($name, $title, $subtitle, 'text'));
    }
    ...
    public function keyCreateTime($name = 'create_time', $title = 'Created', $subtitle = NULL)
    {
    ...
    public function keyUpdateTime($name = 'update_time', $title = 'Change the time', $subtitle = NULL)
    {
        return $this->keyTime($name, $title, $subtitle);
    }
    ...
    public function buttonSubmit($url = '', $title = "SUBMIT")
    {
        if ($url == '') {
    ...
    public function buttonBack($title = 'return')
    {
        $attr = array();
    ...
    public function buttonLink($title = 'Push button', $attr)
    {
