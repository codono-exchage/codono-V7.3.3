<?php
/*
./simplewallet --wallet-file=first.wallet --pass=passwordhere --rpc-bind-port=8070 --rpc-bind-ip=127.0.0.1 --daemon-host=127.0.0.1
*/
...
class Karbo {
	 ...
	 */
	public function __construct ($rpc_host = '127.0.0.1', $rpc_port = 18083, $protocol = 'http', $user = null, $password = null,$rpc_ssl=false) {
	...
	public function deAmount($amount = 0)
  {
	...
	public static function checkPaymentId($payment_id) {
		$result = preg_match("\"[\dA-Fa-f]{64}$\"", $payment_id);
  ...
  public function open_wallet($filename = 'first.wallet', $walletpassword = null)
  {
    $params = array('filename' => $filename, 'password' => $walletpassword);
    $args = [];
     $args["jsonrpc"] = self::RPC_V;
     $args["method"] = "open_wallet";
     $args["id"] = $this->id_connection;
     $args["params"] = $params;
  ...
  public function create_address($account_index = 0, $label = '')
  {
      ...
      $args = [];
      $args["jsonrpc"] = self::RPC_V;
      $args["method"] = "create_address";
      $args["id"] = $this->id_connection;
      $args["params"] = $params;
      $create_address_method=  $this->apiCall($args);
