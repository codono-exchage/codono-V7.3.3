...
{
    /**
     * Convert an array into a tree format
     *
     * @param array $list
     * @param integer $level Input line return time pass parameter use
     */
    private $formatTree;
    private $dataList;
    ...
    private function _toFormatTree($lists, $level = 0, $title = 'title')
    {
