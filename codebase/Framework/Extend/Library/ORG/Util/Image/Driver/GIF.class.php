...
class GIF
{
    ...
    /**
     * Each frame waiting time list
     * @var array
     */
    private $delays = array();

    /**
     * structuremethod,FordecodingGIFimage
     * @param string $src GIFImage data
     * @param string $mod Image data type
     */
    public function __construct($src = null, $mod = 'url')
    {
        if (!is_null($src)) {
            ...
            try {
                ...
                throw new Exception("decodingGIFPicture Error");
            }
        }
    }

    /**
     * Set uporGet the currentframeofdata
     * @param  string $stream Binary data stream
     * @return boolean        Obtained data
     */
    ...
    /**
     * willcurrentFrame to the next frame
     * @return string Current frame data
     */
    ...
    /**
     * Coding and save the currentGIFimage
     * @param  string $gifname Picture Name
     */
